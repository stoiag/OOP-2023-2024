...
// Setati calea pentru Qt instalat la (*) prin selctia Extension-> Qt VS Tools -> Qt Versions, cautati calea pentru qmake.exe instalata (ex. D:\Qt\6.5.1\msvc2019_64\bin)
// Daca IDE-ul da eroare la instructiunile include pentru pachete Qt,
// setati Extensions->Qt VS Tools->Qt Project Settings->sectiunea General->sectiunea Qt Modules, si
